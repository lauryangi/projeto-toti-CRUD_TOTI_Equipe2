                            ...
                            <div className="card-body">
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-lg-12">
                                        ...
                                        {nome.length==0 && validation && <span className="text-danger">Enter the nome</span>}
                                        </div>
                                    </div>
                                    ...
                                    <div className="col-lg-12">
                                        <div className="form-group">
                                            ...
                                            <input value={nacionalidade} onChange={e=>phonechange(e.target.value)} className="form-control"></input>
                                        </div>
                                    </div>
